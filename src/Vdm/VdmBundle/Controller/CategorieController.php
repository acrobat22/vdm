...
use Vdm\VdmBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Vdm\VdmBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('Vdm\VdmBundle\Form\CategorieType', $categorie);
